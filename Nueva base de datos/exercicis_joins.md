...
5\. Mostra una llista amb el nom del passejador, els anys d'experiència i el nom del gos, ordenada per anys d'experiència descendent. Inclou passejadors sense gossos.
...
7\. Quants gos hi ha de cada raça? Mostra el nom de la raça i el nombre de gossos, incloent les races sense cap gos (amb 0). Ordena per nombre de gos descendent.




8\. Mostra el nom del gos, el nom de la seva raça i el nom del seu passejador. Inclou els gossos sense passejador (NULL). Utilitza dos JOINs en la mateixa consulta.
...
L'empresa tecnologica "ITB Solutions" te la seva plantilla organitzada per departaments. Cada empleat pertany obligatoriament a un departament. L'equip de RRHH necessita diverses consultes per gestionar la informacio de personal.
